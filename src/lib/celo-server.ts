...
// one landed on the day S1 prizes went claimable.
//
// NOTE: this is called from /api/relay/forward. It is not dead code — do not
// delete it as "unused" without removing that call site first.
