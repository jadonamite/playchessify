export const getChainConfig = (isTestnet: boolean) => ({
  chainId: isTestnet ? 44787 : 42220,
  usdmAddress: isTestnet ? '0x874069Fa1Eb16D44d622F2e0Ca25eeA172369bC1' : '0x765DE816845861e75A25fCA122bb6898B8B1282a',
})
...
const { chainId: CELO_CHAIN_ID, usdmAddress: USDM_ADDRESS } = getChainConfig(IS_TESTNET)

export { CELO_CHAIN_ID, USDM_ADDRESS }
