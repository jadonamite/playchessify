export const getChainId = (network: string): number => network === 'alfajores' ? 44787 : 42220;
export const getUsdmAddress = (network: string, testnetAddress: string, mainnetAddress: string): string => network === 'alfajores' ? testnetAddress : mainnetAddress;
...
export const USDM_ADDRESS = getUsdmAddress(
