export const createAbi = (abi: any[]) => abi as const;

export const CHESS_TOKEN_ABI = createAbi([
...
export const CHESS_GAME_ABI = createAbi([
  ...
  { "type": "function", "name": "getGame", "stateMutability": "view", "inputs": [{ "name": "gameId", "type": "uint256" }], "outputs": [{ "type": "tuple", "components": [ { "name": "white", "type": "address" }, { "name": "black", "type": "address" }, { "name": "wager", "type": "uint256" }, { "name": "status", "type": "uint8" }, { "name": "result", "type": "uint8" }, { "name": "createdAt", "type": "uint256" }, { "name": "drawProposer", "type": "address" } ]}] },
