...
const WalletProvider = dynamic(() => import('@/components/wallet-provider').then(mod => mod.WalletProvider), { ssr: false })
...
export function Providers({ children }: { children: React.ReactNode }) {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <PrivyProvider appId={process.env.NEXT_PUBLIC_PRIVY_APP_ID ?? 'placeholder-set-env-var'} config={getPrivyConfig()}>
