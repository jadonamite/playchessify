...
const getButtonContent = (
  ...
  <>
    ...
    >
      {loading ? loadingLabel : holding ? holdingLabel : label}
    </span>
  </>
)
...
export default function HoldButton({
  ...
  return (
    <motion.button
      ...
      disabled={inactive}
      aria-label={label}
      style={getButtonStyles(holding, inactive, accent, fullWidth)}
    >
      {getButtonContent(holding, loading, accent, holdMs, holdingLabel, loadingLabel, label)}
    </motion.button>
  )
}
