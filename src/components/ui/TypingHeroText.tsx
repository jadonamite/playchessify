...
const getHeroHeadlineStyles = (index: number, words: string[]) => ({
...
export default function TypingHeroText({
  ...
  useEffect(() => {
    const stop = getAnimationControls(count, index, words, setIndex);
    return stop;
  }, [index, count, words]);
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          style={getHeroHeadlineStyles(index, words)}
        >
          {prefix}
        </motion.div>
        {/* Line 2: "IS VERIFIED" */}
