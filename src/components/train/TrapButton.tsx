...
const getButtonStyle = (accent: string, fullWidth: boolean, disabled: boolean, style: any) => ({
  border: 'none',
  textAlign: 'center',
...
const handleMouseEnter = (e: any, disabled: boolean) => {
  if (!disabled) {
...
export default function TrapButton({
  ...
  return (
    <button
      {...props}
      disabled={disabled}
      style={getButtonStyle(accent, fullWidth, disabled, style)}
